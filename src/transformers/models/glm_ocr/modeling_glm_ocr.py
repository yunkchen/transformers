...
class GlmOcrDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: GlmOcrTextConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
        ...
        self.self_attn = GlmOcrAttention(config, layer_idx)
...
class GlmOcrTextModel(GlmOcrPreTrainedModel):
    ...
    _can_record_outputs = {
        "hidden_states": GlmOcrDecoderLayer,
        "attentions": GlmOcrAttention,
    }
