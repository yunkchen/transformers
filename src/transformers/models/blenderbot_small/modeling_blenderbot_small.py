...
class BlenderbotSmallEncoder(BlenderbotSmallPreTrainedModel):
    ...
    _can_record_outputs = {
        "hidden_states": BlenderbotSmallEncoderLayer,
        "attentions": BlenderbotSmallAttention,
    }
...
class BlenderbotSmallDecoder(BlenderbotSmallPreTrainedModel):
    ...
    _can_record_outputs = {
        "hidden_states": BlenderbotSmallDecoderLayer,
        "attentions": OutputRecorder(BlenderbotSmallAttention, index=1, layer_name="self_attn"),
        "cross_attentions": OutputRecorder(BlenderbotSmallAttention, index=1, layer_name="encoder_attn"),
    }
