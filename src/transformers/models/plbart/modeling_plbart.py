...
class PLBartEncoder(PLBartPreTrainedModel):
    ...
    _can_record_outputs = {
        "hidden_states": PLBartEncoderLayer,
...
class PLBartDecoder(PLBartPreTrainedModel):
    ...
    _can_record_outputs = {
        "hidden_states": PLBartDecoderLayer,
        "attentions": OutputRecorder(PLBartAttention, index=1, layer_name="self_attn"),
